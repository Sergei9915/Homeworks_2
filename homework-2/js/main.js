...
const minus = stringToNumberA - stringToNumberB; // Первое и второе число отнимаются;
const multiply = stringToNumberA * stringToNumberB; // Первое и второе число умножаются;
const divide = stringToNumberA / stringToNumberB; // Первое и второе число делится;

alert(`${a} + ${b} = ${add}; 
${a} - ${b} = ${minus}; 
${a} * ${b} = ${multiply}; 
${a} / ${b} = ${divide}.`); // Показываем пользователю результат;